...
* [BREAKING][type][rust] Added the `TransactionRequestError::ForeignAccountVaultMismatch` variant, so exhaustive matches on `TransactionRequestError` must handle it ([#2413](https://github.com/0xMiden/rust-sdk/pull/2413)).
