...
impl TransactionRequestBuilder {
    ...
    /// every client that executes the request commits to the same input notes and produces the same
    /// transaction summary. Use this for a request that is shared across clients.
    ///
