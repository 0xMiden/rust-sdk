...
impl StateSync {
    ...
    fn apply_transactions_and_nullifiers(
        ...
        for transaction in transactions {
            ...
            Self::mark_erased_output_notes_as_consumed(state_sync_update, transaction);
    ...
    fn mark_erased_output_notes_as_consumed(
        state_sync_update: &mut StateSyncUpdate,
    ...
    fn record_consumed_unauthenticated_input_notes(
        state_sync_update: &mut StateSyncUpdate,
        transaction: &RpcTransactionRecord,
    ) {
