...
* [BREAKING][type][rust] Added `NodeRpcClient::is_account_allowed` and the `ClientError::AccountNotAllowlisted` variant ([#2550](https://github.com/0xMiden/rust-sdk/pull/2550)).
