...
* [BREAKING][type][rust] Added the `ClientError::ChainAnchorError` variant, so exhaustive matches on `ClientError` must handle it ([#2421](https://github.com/0xMiden/rust-sdk/pull/2421)).
