...
///
/// An implementation owns the web3 signer's base URL, prepends it to the given `path`, and maps
/// any non-success response status to [`Web3SignerError::Transport`]. On success, both methods
