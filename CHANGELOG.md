...
* [BREAKING][rust] Updated protocol types for transaction logs and VM 0.33. Serialized transaction details now include logs and their secret salt.
...
* [FEATURE][rust] Added public transaction log queries by account and SQLite caching. Retained private log contents and their secret salts in local transaction records.
