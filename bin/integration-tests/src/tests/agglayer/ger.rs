...
///
/// TODO: rename back to `test_agglayer_update_ger` once protocol `0.17.0-rc.5` is released.
pub async fn ignored_test_agglayer_update_ger(client_config: ClientConfig) -> Result<()> {
