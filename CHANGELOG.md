...
### Fixes
* [FIX][rpc] `VerifyingRpcClient::get_account` now rejects an `AccountProof` whose account ID does not match the requested one, consistent with the other identity-scoped verifying methods ([#2396](https://github.com/0xMiden/rust-sdk/issues/2396)).
