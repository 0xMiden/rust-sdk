...
| `funding` | Enables development faucet requests and `Client::fund_account`. **Disabled by default.** See [account funding](../../docs/external/src/rust-client/library.md#fund-a-development-account). |
